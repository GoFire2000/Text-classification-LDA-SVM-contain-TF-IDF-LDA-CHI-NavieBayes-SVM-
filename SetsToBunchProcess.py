...
from Tools import readFile, saveFile, writeBunchObj
...
if __name__ == "__main__":
    ...
    target_bunch_path = "./BunchOfTrainingSets.dat"
    ...
    target_bunch_path = "./BunchOfTestSets.dat"
    SetsToBunchProcess(training_sets_path, target_bunch_path)
